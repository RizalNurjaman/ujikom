...
use Validator;
use Input;
class Cgolongan extends Controller
{
    /**
    ...
    {
        $golongin=Mgolongan::paginate(10);
        return view('golongan.index',compact('golongin'));
        //
    }
    ...
    public function create()
    {
        ...
        return view('golongan.create',compact('golongin'));
 //
    }
    ...
    public function store(Request $request)
    {
        ...
        $golongin=Request::all();
        Mgolongan::create($golongin);
    ...
    {
        //
        $golongin=Mgolongan::find($id);
        return view('golongan.edit',compact('golongin'));
    }
