        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     ...
                     {!! Form::model($golongin,['method'=>'PATCH','route'=>['golongan.update',$golongin->id]]) !!}
                    <div class="col-md-6">
                    <label>Kode Golongan</label>
                        <input type="text" name="kode_golongan" class="form-control" value="{{$golongin->kode_golongan}}">
                        <span>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama_golongan" class="form-control" value="{{$golongin->nama_golongan}}">
                        <span>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="besaran_uang" class="form-control" value="{{$golongin->besaran_uang}}">
                        <span>
