        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     ...
                     {!! Form::model($jabatin,['method'=>'PATCH','route'=>['jabatan.update',$jabatin->id]])!!}
                    <div class="col-md-6">
                        <label>Kode Jabatan</label>
                        <input type="text" name="kode_jabatan" class="form-control" value="{{$jabatin->kode_jabatan}}" >
                    ...
                    <div class="col-md-6">
                        <label>Jabatan</label>
                        <input type="text" name="nama_jabatan" class="form-control" value="{{$jabatin->nama_jabatan}}" >
                        <span class="help-block">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="besaran_uang" class="form-control" value="{{$jabatin->besaran_uang}}" >
                        <span class="help-block">
