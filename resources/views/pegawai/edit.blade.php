            ...
            <div class="col-md-8 ">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                     {!!Form::model($pegawaw,['method'=>'PATCH','route'=>['pegawai.update',$pegawaw->]])!!}
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="nip" value="{{$pegawaw->nip}}" type="text" class="form-control" name="nip" autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach($jabatan as $datajabatan)
                                    @if($datajabatan->id == $pegawaw->jabatan_id)
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach($golongan as $datagolongan)
                                    @if($datagolongan->id == $pegawaw->golongan_id)
